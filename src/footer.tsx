  ...
  return (
    <footer className="px-[24px] lg:px-[80px] z-40 py-[32px] flex flex-col lg:flex-row gap-[42px] items-center justify-between w-full bg-white">
      ...
      <a
        href="https://jeffreydev.vercel.app/"
        target="_blank"
        className="text-base leading-[21.6px] tracking-[-0.48px] be-vietnam-pro-medium text-white bg-[#854dff] border border-[#854dff] rounded-lg px-[18px] py-2.5 flex items-center justify-center max-w-max whitespace-nowrap hover:bg-[#6c2ed9] transition"
      >
        Get Partner Packet
      </a>
    </footer>
